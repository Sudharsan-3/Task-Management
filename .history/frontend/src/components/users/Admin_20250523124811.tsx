...
const COLORS = ['#34D399', '#3B82F6', '#FBBF24']; // completed, in-progress, draft
      ...
      {isSuccess && (
        <div>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
            {data.users.map((usr) => {
              const tasks = usr.tasks_tasks_user_idTousers || [];
              ...
              return (
                ...
                >
                  <h3 className="text-xl font-bold text-gray-800 mb-1">{usr.name}</h3>
                  <p className="text-sm text-gray-600 mb-3">{usr.email}</p>

                  <p className="text-sm font-medium text-gray-700 mb-4">
                    Total Tasks Assigned by You: {tasks.length}
                  </p>
                  ...
                  {tasks.length > 0 ? (
                    <>
                      ...
                      <div className="text-sm space-y-1">
                        <p><span className="font-semibold text-green-600">✔ Completed:</span> {completed}</p>
                        <p><span className="font-semibold text-blue-600">⏳ In Progress:</span> {inProgress}</p>
                        <p><span className="font-semibold text-yellow-500">📝 Draft:</span> {draft}</p>
                      </div>
                    </>
                  ) : (
