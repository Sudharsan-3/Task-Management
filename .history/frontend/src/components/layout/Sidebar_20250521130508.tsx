    ...
    <>
      ...
      >
        ...
        <div className="p-4 border-t border-gray-700">
          <div className={`flex items-start ${isCollapsed && !isMobile ? 'justify-center' : ''}`}>
...
// if(data != null){
//       if(value.role === "admin"){
//         menuItems = [{ path: '/', name: 'Welcome', icon: <FaTh /> },
...
//         ]
//         console.log(value.name,"sidebar")

//       }else if(value.role == "user"){
//         menuItems = [{ path: '/', name: 'Welcome', icon: <FaTh /> },
//           {path: '/userPage', name: 'User Page', icon: <FaCog />, auth: true },
         
//           { path: '/userDataPage', name: 'Tasks', icon: <FaTasks />, auth: true },
//           { path: '/user-tasks-completed', name: 'Completed', icon: <FaChartBar />, auth: true },

//           { path: '/profile', name: 'Profile', icon: <FaUserCircle />, auth: true },
//         ]
//         console.log(value.name,value.id,"sidebar")
//       }
//     }
//     else{
//       menuItems = [{ path: '/', name: 'Welcome', icon: <FaTh /> },]
