...
<div className="lg:hidden space-y-4">
  {filteredTasks.map((task) => (
    <div
      key={task.id}
      className="border border-gray-300 rounded-md p-4 shadow-sm bg-white w-full"
    >
      <div className="flex justify-between items-center mb-2 flex-wrap gap-y-2">
        <h2 className="text-sm font-semibold text-gray-800 break-words w-full">
          {task.task_name}
        </h2>
        <span
      ...
      <p className="text-xs mb-1 text-gray-600 break-words">
        <strong>Ticket:</strong> {task.ticket}
      </p>
      <p className="text-xs mb-1 text-gray-600 break-words">
        <strong>Creator:</strong> {task.creator_name}
      </p>
      <p className="text-xs mb-1 text-gray-600 capitalize">
      ...
      <div className="flex flex-wrap gap-3 mt-3">
        <button
          ...
          className="flex items-center gap-1 text-blue-600 hover:underline hover:cursor-pointer text-sm"
        >
          <Eye size={18} />
          Update
        </button>
        {task.status.toLowerCase() !== "completed" && (
          <button
            ...
            className="flex items-center gap-1 text-green-600 hover:underline hover:cursor-pointer text-sm"
          >
            <CheckCircle size={18} />
            Complete
          </button>
