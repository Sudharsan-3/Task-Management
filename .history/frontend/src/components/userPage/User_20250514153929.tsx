...
import { Eye } from "lucide-react"; // optional: use any icon lib like lucide or font-awesome
              ...
              {data.data.tasks.map((task: any, index: number) => (
                ...
                >
                  ...
                  <td className="py-2 px-4">
                    <button
                      onClick={() => navigate(`/user-task-response/${task.id}`,{state:task.id})}
...
//         <button
//           className="bg-indigo-600 text-white px-4 py-2 rounded hover:bg-indigo-700"
//           onClick={() => {}} // Currently shows all tasks
//         >
//           Your Tasks
//         </button>
