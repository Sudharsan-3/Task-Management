    ...
    <div className="min-h-screen bg-white p-4 sm:p-6">
      ...
      {tasks.length > 0 ? (
        <>
          ...
          <div className="hidden md:block overflow-auto border border-gray-300 rounded-md">
            ...
            {tasks.map((task: any, index: number) => (
              ...
              >
                <div className="flex justify-between mb-2">
                  <span className="font-semibold text-gray-700">S.No: {index + 1}</span>
                  <span
                    className={`px-2 py-1 rounded-full text-xs font-semibold capitalize
                      ${
                        task.priority === "high"
                ...
                <p>
                  ...
                  <span className="capitalize">{task.user_name}</span>
                </p>
                <p>
                  <span className="font-semibold text-gray-700">Task Name:</span> {task.task_name}
                </p>
                <p>
                ...
                <p>
                  <span className="font-semibold text-gray-700">User Comment:</span>{" "}
                  {task.user_comments || "—"}
                </p>
              </div>
            ))}
