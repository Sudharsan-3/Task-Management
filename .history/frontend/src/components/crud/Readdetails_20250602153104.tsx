...
const Readdetails = () => {
  ...
  console.log('Status:', state?.task.status, 'Color:', getStatusColor(state?.task.status));
      ...
      <div className="bg-white shadow-md rounded-xl p-6 max-w-2xl mx-auto space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className='flex gap-2'>
            ...
            <p className={`${getStatusColor('completed')} font-medium`}>
  completed
</p>
<p className={`${getStatusColor('pending')} font-medium`}>
  pending
</p>
<p className={`${getStatusColor('draft')} font-medium`}>
  draft
</p>
