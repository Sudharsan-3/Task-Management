...
const Readdetails = () => {
  ...
  const getPriorityColor = (priority:string) => {
    console.log(priority,"from Readdetails in priority")
  ...
  const getStatusColor = (status:string) => {
    console.log(status,"from Readdetails")
      ...
      <div className="bg-white shadow-md rounded-xl p-6 max-w-2xl mx-auto space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className='flex gap-2'>
            ...
            <p className={`${getStatusColor(state?.task.status)} ${console.log(state?.task.status,"form datas")} font-medium`}>
              {state?.task.status}
            </p>
          </div>
        </div>
