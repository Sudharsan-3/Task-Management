...
const Edittasks: React.FC = () => {
  ...
  const updateUserData = async () => {
    try {
      // Simulate successful API update (replace with actual API call)
      // Example: await api.put(`/api/task/${task.id}`, { task_name, task_description, priority });

      setSuccessMessage('Task updated successfully!');
      setTimeout(() => {
        navigate('/task'); // navigate back to task list after update
