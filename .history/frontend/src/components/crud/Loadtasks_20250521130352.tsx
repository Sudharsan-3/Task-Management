  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      ...
      <div className="flex items-center justify-between mb-4 mt-10">
        <button
          onClick={() => navigate(-1)}
          className="flex items-center gap-2 px-4 py-2 text-sm rounded-md bg-gray-200 hover:bg-gray-300 transition"
        >
          <FaArrowLeft /> Back
        </button>
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="bg-green-200 hover:bg-green-300 text-black font-bold py-2 px-4 rounded cursor-pointer"
            title="Add Task"
          >
            Create Tasks
          </button>
